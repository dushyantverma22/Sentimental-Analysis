...
MLFLOW_TRACKING_URI = "https://dagshub.com/dushyantverma414/Sentimental-Analysis.mlflow"
dagshub.init(repo_owner="dushyantverma414", repo_name="Sentimental-Analysis", mlflow=True)
...
if __name__ == "__main__":
    (X_train, X_test, y_train, y_test), vectorizer = load_and_prepare_data("data//raw//IMDB.csv")
